...
cv1 = (Image.open("interface_impl/hoja.jpg")).resize((WND_WIDTH // 2 - 40, WND_HEIGHT // 2 + 45), Image.ANTIALIAS)
me = (Image.open("interface_impl/IMG_20210722_134115.jpg")).resize(((WND_WIDTH // 2 - 28) // 2, (WND_HEIGHT // 4 + 45) // 2),
                                                    Image.ANTIALIAS)

schimg1 = (Image.open("interface_impl/schoolimg1.png").resize((WND_WIDTH // 2 + 10, (WND_HEIGHT - 60) // 3), Image.ANTIALIAS))
schimg2 = (Image.open("interface_impl/schoolimg2.png").resize((WND_WIDTH // 2 + 10, (WND_HEIGHT - 60) // 3), Image.ANTIALIAS))
schimg3 = (Image.open("interface_impl/schoolimg3.png").resize((WND_WIDTH // 2 + 10, (WND_HEIGHT - 55) // 3), Image.ANTIALIAS))
